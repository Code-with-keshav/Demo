...
//=================================================================================================
	public LinkList reverseList(Node head) {
//		if (head == null)return;
...
//		System.out.println(head.data+" ");    
		...
		for (int j = size; j > 0; j--) {
			...
			newList.addLast(newNode.data);
		}
		return newList;
	}
//===========================================================================================
	public void reverseItretive() {
...
//==========================================================================================
	public static void main(String[] args) {
		...
		intLL.addInBet(3, "7");
		intLL.addInBet(4, "5");
		System.out.println(intLL.getSize());
		System.out.println(intLL.getIndex("1"));
        
		//LinkList reversedList = intLL.reverseList(intLL.head);
		intLL.printList();
		//reversedList.printList();
		intLL.reverseList(intLL.head).printList();  
		
		intLL.reverseItretive();
		intLL.printList();
		intLL.reverseItretive();
		intLL.printList();		
		
        intLL.head = intLL.reverseRecursive(intLL.head);
        intLL.printList();
